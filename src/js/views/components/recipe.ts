...
export class Recipes implements Widget {
    ...
    sigSelectRecipeClicked = new Signal<SelectRecipe>();
    ...
    setRecipe(results: SelectRecipe[]): void {
        this.el.innerHTML = "";
        ...
        results.forEach(r => {
            ...
            element(`
                <figure class="recipe__fig">
                    <img src="${r.recipe__img}" alt="Tomato" class="recipe__img">
                    <h1 class="${r.recipe__title}">
                        <span>Pasta with tomato cream sauce</span>
                    </h1>
                </figure>
            `);
            select.addEventListener("click", () => {
                this.sigSelectRecipeClicked.emit(r);
            });
